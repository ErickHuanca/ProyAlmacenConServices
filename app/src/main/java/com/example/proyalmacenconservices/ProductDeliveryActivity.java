...
//    private TextView pQuantit;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pEtDestinatario= (EditText) findViewById(R.id.etDestinatario);

        pTvMuestraAdiProd = (TextView) findViewById(R.id.tvMuestraProd);
        pTvMuestraAdiCant = (TextView) findViewById(R.id.tvMuestraQuan);
        pTvMuestraUMedida = (TextView) findViewById(R.id.tvUnidadMedida);
    ...
    public void btnEntregar (View vista){
        ...
        String datoDestinatario = pEtDestinatario.getText().toString();

        if (datoMosProducto != "Seleccionar" && datoCantidadEntreda != null && !datoCantidadEntreda.equals("") && !datoDestinatario.equals("")){
            ...
            if (nCantidad>0){
                ...
                deliveryHistory(datoSpProducto, nCantidad, datoDestinatario, currentDate, currentTime, idUser);
                ...
                datoMuestraUnid = datoMuestraUnid + pTvMostrarMedida.getText().toString() +"\n";
...
//            actualizacionCantidad(producto, nCantidad);
    ...
    public void deliveryHistory(String datoSpProducto, int nCantidad, String destinatario, String currentDate, String currentTime, String idUser) {
