...
public class ProductReceiptActivity extends AppCompatActivity {
    ...
    private EditText pEtNombreEmisor;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pEtNombreEmisor = (EditText) findViewById(R.id.etNombreEmisor);
    ...
    public void adicionar (View vista){
        ...
        String nombre = pEtNombreEmisor.getText().toString();
        ...
        if (producto != "Seleccionar" && cantidad != null && !cantidad.equals("") && seccion != "Ninguno"){
            ...
            cargarDatosFirebase(producto, seccion, nCantidad, nombre, idProd, idUser, currentDate, currentTime);
    ...
    public void cargarDatosFirebase(String producto, String seccion, int nCantidad, String nombre, String idProd, String idUser, String currentDate, String currentTime) {
...
//            });
    ...
    public Map<String, Object> receiptHistory(String producto, String seccion, int nCantidad, String nombre, String idProd, String idUser, String currentDate, String currentTime) {
        Map<String,Object> map = new HashMap<>();
        map.put("iduser",idUser);
        map.put("product",producto);
        map.put("quantity",nCantidad);
        map.put("nombreEmisor",nombre);
...
//        pEtNombreEmisor.setText("");
        pTvProductoLibre.setText("0");
        pTvProductoCapacidad.setText("0");
    }

    public void finalizar (View vista){
        startActivity(new Intent(ProductReceiptActivity.this, HomeActivity.class));
        finish();
    }
